...
{
    public class KCutStartWithCenterNode : Deployment
    {
        ...
        public KCutStartWithCenterNode(double percentageOfTunnelingTracer, double percentageOfMarkingTracer, double percentageOfFilteringTracer, int KCutValue, int numberOfInsideScopeNode)
