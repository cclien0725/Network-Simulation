...
{
    public class KCutStartWithSideNodeCoefficientAndMinDegree : Deployment
    {
        ...
        public KCutStartWithSideNodeCoefficientAndMinDegree(double percentageOfTunnelingTracer, double percentageOfMarkingTracer, double percentageOfFilteringTracer, int KCutValue, int numberOfInsideScopeNode)
