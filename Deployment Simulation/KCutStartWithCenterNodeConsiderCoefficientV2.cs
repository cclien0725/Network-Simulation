...
{
    public class KCutStartWithCenterNodeConsiderCoefficientV2 : Deployment
    {
        ...
        public KCutStartWithCenterNodeConsiderCoefficientV2(double percentageOfTunnelingTracer, double percentageOfMarkingTracer, double percentageOfFilteringTracer, int KCutValue, int numberOfInsideScopeNode)
