...
{
    public class MarkingAssistanceSimulator
    {
        ...
        public MarkingAssistanceSimulator(Deployment deployment, NetworkTopology topology, SQLiteUtility sql, string version)
        {
